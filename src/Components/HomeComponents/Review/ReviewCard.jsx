...
const ReviewCard = ({data}) => {
   ...
   return (
      <div data-aos="zoom-in" className="py-4 lg:py-8 px-5 md:p-5 rounded-xl border text-left hover:shadow-xl transition-shadow relative">
         <div className="flex gap-3 items-center">
            <div className="w-[20%] lg:w-3/12 md:w-2/12">
               <img style={{width: '50px', height: '50px'}} src={authorImage} className="rounded-full" alt="user" />
            </div>
            <div>
               <h5 className="font-medium text-lg">{authorName}</h5>
               ...
               <img src={quote} style={{width: '40px', height: '40px'}} className="absolute top-5 right-5" alt="quote" />
            </div>
         </div>
