...
const PostReviews = ({bookedUserEmail, room_number}) => {
   ...
   return (
      <form onSubmit={handleNewReview}  className="py-8">
         ...
         <div className="mt-3">
            <input type="text" name="rating" className="focus:outline-none border border-gray-300 rounded-md w-1/2 md:w-1/4 px-3 py-1" placeholder="Rating" />
         </div>
         <div className="mt-3">
            <textarea type="text" name="review" rows={5} className="focus:outline-none border border-gray-300 rounded-md w-full md:w-3/4 px-3 py-2" placeholder="Your experience" />
         </div>
